...
public class Controller : MonoBehaviour
{
    ...
    void Update()
    {
        if (CanPause && Input.GetButtonDown("Menu") /*oculus�� ���� - OVRInput.GetDown(OVRInput.Button.One)*/)
        {
        ...
        if (!m_IsPaused && !LockControl)
        {
            ...
            if (m_Grounded && Input.GetButtonDown("Jump")/* ��ŧ������ ���� - OVRInput.GetDown(OVRInput.Button.SecondaryThumbstick)*/)
            {
