...
public class Controller : MonoBehaviour
{
    ...
    void Update()
    {
        if (CanPause && Input.GetButtonDown("Menu") /*oculus로 연결 - OVRInput.GetDown(OVRInput.Button.One)*/)
        {
        ...
        if (!m_IsPaused && !LockControl)
        {
            ...
            if (m_Grounded && Input.GetButtonDown("Jump")/* 오큘러스로 연결 - OVRInput.GetDown(OVRInput.Button.SecondaryThumbstick)*/)
            {
